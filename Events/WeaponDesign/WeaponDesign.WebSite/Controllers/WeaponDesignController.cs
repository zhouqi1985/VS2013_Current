...
using WeaponDesign.WebSite.Filter;
using WeaponDesign.WebSite.Models;
using ObjectUtil.Common;

namespace WeaponDesign.WebSite.Controllers
{
    [CatchErrors]
    public class WeaponDesignController : PageControllerBase.BaseController
    {

        private WeaponDesign.DAL.WeaponDesignDAL dal = new DAL.WeaponDesignDAL();
        private readonly WeaponDesign.DAL.WCF.Client.WeaponDesignServiceClient WeapDesignBll = new DAL.WCF.Client.WeaponDesignServiceClient();
        ...
        public ActionResult EditWeapon(WeaponList model)
        {
            ...
            weaponlists.FirstName = model.FirstName.Trim();
            weaponlists.Gender = model.Gender.Trim();
            weaponlists.ContactMethod = model.ContactMethod.Trim();
